function S3=s3wlc_2(NM,FA,Q1,Q2,Q3)
...
function INTL1L2=inv_laplace(NR,R1,R2,GL1,GL2,ORDL)

INTL1L2=zeros(ORDL,1);
for N1=1:NR
    for N2=1:NR
        EIG1=R1(N1);
        EIG2=R2(N2);

        Res=GL1(N1,1,1,:)*GL2(N2,1,1,:);
        INTL1L2(:)=TINL1L2(:)
    end
end
end
...
%                                     sum(PL12.*GL1(:,N1).*GL2(:,N2));
    ...
    S3(1,1,1)=S3(1,1,1)+sum(PL12.*INTL1L2);
