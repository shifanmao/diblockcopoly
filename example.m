...
plotphase(N,FAV);
saveas(gca,'example_figures/MFphase.eps','epsc')

% Figure 2: make a phase diagram with density fluctuations
plotphaseRG(N,C,FAV);
saveas(gca,'example_figures/FLCphase.eps','epsc')
...
saveas(gca,'example_figures/FLCspinodal2.eps','epsc')

% Figure 5: density-density correlations
densityRG(N,C,0.5);
saveas(gca,'example_figures/psi2.eps','epsc')
...
saveas(gca,'example_figures/gam3.eps','epsc')

figure;plot(FAV,gam4*N,'k-','linewidth',2);xlim([0.3,0.5]);
xlabel('f_A');ylabel('N\Gamma_4(q^*)')
saveas(gca,'example_figures/gam4.eps','epsc')
